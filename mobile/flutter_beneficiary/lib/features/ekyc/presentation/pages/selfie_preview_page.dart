...
class SelfiePreviewPage extends StatelessWidget {
  ...
  const SelfiePreviewPage({super.key, this.photoPath});
  ...
  Widget _buildPreviewImage(String? path) {
    ...
    return Image.asset(
      'assets/flat/selfie_with_id_ktp-2.png',
      fit: BoxFit.cover,
    );
  }
  ...
  void _handleNext(BuildContext context) {
    EkycProgressStore.setStatus('selfie', EkycStepStatus.done);
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Konfirmasi Selfi KTP'),
          centerTitle: false,
          leading: IconButton(
