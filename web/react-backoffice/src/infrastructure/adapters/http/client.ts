...
export const backofficeHttpClient = new HttpClient(appEnv.services.apiBackoffice, {}, getSessionToken)
export const gatewayHttpClient = new HttpClient(appEnv.services.apiGateway)
