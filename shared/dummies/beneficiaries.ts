...
export const beneficiaries: BeneficiarySeed[] = [
  {
    ...
    timeline: [
      ...
      {
        at: "2025-10-19T09:15:00Z",
        by: "ADM-1",
        action: "DESK_REVIEW_STARTED",
      },
    ],
  ...
  },
  {
    ...
    visits: [visit("VST-4001", "2025-10-20T03:00:00Z", "IN_PROGRESS")],
    timeline: [
      { at: "2025-10-15T07:10:00Z", by: "system", action: "SUBMITTED" },
      { at: "2025-10-15T07:12:00Z", by: "scoring", action: "SCORED" },
      {
        at: "2025-10-18T06:20:00Z",
        by: "ADM-1",
        action: "FIELD_VISIT_REQUESTED",
      },
      {
        at: "2025-10-20T02:55:00Z",
        by: "TKSK-1002",
        action: "VISIT:IN_PROGRESS",
      },
    ],
  ...
  },
  {
    ...
    visits: [visit("VST-4002", "2025-10-12T02:00:00Z", "SUBMITTED")],
    timeline: [
      { at: "2025-10-10T05:30:00Z", by: "system", action: "SUBMITTED" },
      { at: "2025-10-10T05:31:00Z", by: "scoring", action: "SCORED" },
      {
        at: "2025-10-12T06:00:00Z",
        by: "TKSK-1002",
        action: "VISIT:SUBMITTED",
      },
      {
        at: "2025-10-13T04:10:00Z",
        by: "ADM-1",
        action: "STATUS:FINAL_APPROVED",
      },
    ],
    recommendedCluster: "PKH",
    recommendedPriority: "TINGGI",
  ...
  },
  {
    ...
    timeline: [
      ...
      {
        at: "2025-10-16T02:40:00Z",
        by: "ADM-1",
        action: "STATUS:RETURNED_FOR_REVISION",
        reason: "Perlu dokumen KK terbaru",
      },
    ],
    recommendedCluster: "BPNT",
    recommendedPriority: "SEDANG",
  ...
  },
  {
    ...
    timeline: [
      ...
      {
        at: "2025-10-08T03:30:00Z",
        by: "ADM-1",
        action: "STATUS:FINAL_REJECTED",
        reason: "Face match rendah dan anomali perangkat",
      },
    ],
  ...
  },
  {
    ...
    timeline: [
      ...
      {
        at: "2025-10-05T05:45:00Z",
        by: "ADM-1",
        action: "STATUS:FINAL_APPROVED",
      },
      {
        at: "2025-10-06T08:00:00Z",
        by: "ADM-1",
        action: "STATUS:DISBURSEMENT_READY",
      },
    ],
    recommendedCluster: "PKH",
    recommendedPriority: "TINGGI",
